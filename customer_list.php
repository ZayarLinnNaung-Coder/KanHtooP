<?php
    ...
    $sql = "SELECT * FROM CURRENT WHERE 1 ORDER BY ID DESC";
    $sqlTwo = "SELECT SUM(total) as tt from CURRENT";
...
<body>
<a href="prev_customer_list.php" class="month"><i class="fas fa-caret-left"></i></a>
<header>
    <div class="nav">
        <div class="brand">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-dark text-light d-flex justify-content-between align-items-center">
                    ...
                    ?>
                    <div><h4><?php echo $currentMonth?></h4></div>
